...
interface Directory<T:Projectable<Certainty>>{
  //public function index():IO<Array<Junction>>;
  //public function insert(name:String):IO<File>;
  //public function junctions():IO<Array<Junction>>;
